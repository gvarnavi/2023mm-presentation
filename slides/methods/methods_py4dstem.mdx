...
- Implemented suite of phase retrieval algorithms, including iterative DPC and Parallax depth-sectioning

<Py4DSTEMImage width="85%" height="auto"/>
...
```python  
  ptycho = SingleslicePtychographicReconstruction(
      ...
      fit_function = "linear", # de-scan correction
  ).reconstruct(
      max_iter = 8,
      step_size = 0.5,
...
See also talk by Stephanie Ribet tomorrow (Wed July 26 @ 11:00am, Room 200B in symposium A04.06)
